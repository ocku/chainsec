...
pub(super) fn rules() -> Vec<Rule> {
    vec![
        ...
        rule!(
            "chainsec.ts.detection.heuristic.computed-global-execution",
            Language::TypeScript,
            FindingType::ArbitraryCodeExecution,
            Risk::High,
            Confidence::High,
        ...
        rule!(
            "chainsec.ts.detection.heuristic.vm-context-execution",
            Language::TypeScript,
            FindingType::ArbitraryCodeExecution,
            Risk::High,
            Confidence::High,
        ...
        rule!(
            "chainsec.ts.detection.heuristic.worker-blob-execution",
            Language::TypeScript,
            FindingType::ArbitraryCodeExecution,
            Risk::High,
            Confidence::High,
        ...
        rule!(
            "chainsec.ts.detection.guarddog.base64-decoded-execution",
            Language::TypeScript,
            FindingType::ArbitraryCodeExecution,
            Risk::High,
            Confidence::High,
        ...
        rule!(
            "chainsec.ts.detection.guarddog.reflective-api",
            Language::TypeScript,
            FindingType::ArbitraryCodeExecution,
            Risk::High,
            Confidence::High,
